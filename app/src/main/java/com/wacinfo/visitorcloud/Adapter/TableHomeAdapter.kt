...
class TableHomeAdapter(private val m_jContext: Context) :
    ...
    internal inner class MyCellViewHolder(itemView: View) : AbstractViewHolder(itemView) {
        ...
        init {
            cell_textview = itemView.findViewById<View>(R.id.cell_data) as TextView
        }
    ...
    override fun onCreateCellViewHolder(parent: ViewGroup, viewType: Int): AbstractViewHolder {
        // Get cell xml layout
        val layout = LayoutInflater.from(m_jContext).inflate(
    ...
    override fun onBindCellViewHolder(
        ...
        viewHolder.cell_textview.text =
            cellItemModel!!.data.toString()
    ...
    internal inner class MyColumnHeaderViewHolder(itemView: View) : AbstractViewHolder(itemView) {
        val cell_textview: TextView = itemView.findViewById<View>(R.id.column_header_textView) as TextView
        val cell_container: LinearLayout = itemView.findViewById<View>(R.id.column_header_container) as LinearLayout
    ...
    override fun onCreateCornerView(parent: ViewGroup): View {
        ...
        corner.setOnClickListener { view: View? ->
            val sortState = this.tableView.rowHeaderSortingStatus
