...
class WhiteListItem /*(1)*/(
    private val mContext: Context,
    private val id: String,
    private val blacklistId: String,
    private val blacklistName: String,
    private val result: RetrofitData.Whitelist.Get.Message.list.Time
) : AbstractFlexibleItem<WhiteListItem.MyViewHolder>(), IFilterable<String> {
